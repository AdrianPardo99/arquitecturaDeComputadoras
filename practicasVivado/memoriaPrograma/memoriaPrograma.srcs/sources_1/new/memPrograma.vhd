...
architecture Behavioral of memPrograma is
    ...
    TYPER & R4 & R0 & R1 & SU & ADD,  --4 SUMA: ADD R4, R0, R1
    SWI & R4 & x"0048",                 --5 SWI R4, 72
    ADDI & R0 & R1 & x"000",            --6 ADDI R0, R1, 0
    ADDI & R2 & R2 & x"001",            --7 ADDI R2, R2, 1
    BNEI & R3 & R2 & x"FFC",            --8 BNEI R3, R2, SUMA
    NOP & SU & SU & SU & SU & SU,       --9 FIN: NOP
    B & SU & x"0009",                   --10 B FIN
    others => (others => '0')
    );
begin
