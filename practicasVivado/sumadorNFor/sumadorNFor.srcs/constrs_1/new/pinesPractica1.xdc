...
set_property PACKAGE_PIN V12 [get_ports {s[7]}]
set_property PACKAGE_PIN V14 [get_ports {s[6]}]
set_property PACKAGE_PIN V15 [get_ports {s[5]}]
set_property PACKAGE_PIN T16 [get_ports {s[4]}]
set_property PACKAGE_PIN U14 [get_ports {s[3]}]
set_property PACKAGE_PIN T15 [get_ports {s[2]}]
